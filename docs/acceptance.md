...
- [x] A deposit that confirms after a cancellation (within the 30-day watch window) is refunded to the buyer, who is notified; extra funds on completed orders are flagged, not paid; older addresses are not polled (`TestLateDepositAfterCloseIsHandled`).
